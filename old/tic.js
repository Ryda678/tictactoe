...
function boxCreate() {
    ...
    if ((box1.toUpperCase() == 'x'.toUpperCase() )
     && (box2.toUpperCase() == 'x'.toUpperCase() )
      && (box3.toUpperCase() == 'x'.toUpperCase() )) {
